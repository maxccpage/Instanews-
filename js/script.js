...
$(document).ready(function () {
	var home = "https://api.nytimes.com/svc/topstories/v2/home";
	home += ".json";
	home += '?' + $.param({
	...
	$.ajax({
		...
		for (var i = 0; i < result.results.length; i++) {
			if (result.results[i].multimedia.length != 0) {
				...
				var article = $('<div class="article"><a style="text-decoration: none; text-align: center;" href=' + linkUrl + '><p></p></a></div>');
